...
const QUICK_ACTIONS = [
  ...
  { icon: '🎒', title: '打包清單', subtitle: '智能生成打包清單', href: '/packing' as const },
  { icon: '💰', title: '預算試算', subtitle: '估算旅行費用', href: '/budget' as const },
  { icon: '🌤️', title: '天氣查詢', subtitle: '查看目的地天氣', href: '/weather' as const },
